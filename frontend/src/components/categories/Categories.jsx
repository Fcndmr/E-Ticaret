          ...
          <div className="container">
            ...
            <ul className="category-list">
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories1.png"
                    alt
              ...
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories2.png"
                    alt
                    className="category-image"
                  />
              ...
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories3.png"
                    alt
                    className="category-image"
                  />
              ...
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories4.png"
                    alt
                    className="category-image"
                  />
              ...
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories5.png"
                    alt
                    className="category-image"
                  />
              ...
              <li className="category-item">
                <a href="#">
                  <img
                    src="../../../public/img/categories/categories6.png"
                    alt
                    className="category-image"
                  />
