          ...
          <div className="slider-elements">
            <div className="slider-item fade">
              <div className="slider-image">
                <img src="../../../public/img/slider/slider1.jpg" className="img-fluid" alt />
              </div>
            ...
            <div className="slider-item fade">
              <div className="slider-image">
                <img src="../../../public/img/slider/slider2.jpg" className="img-fluid" alt />
              </div>
              <div className="container">
                <p className="slider-title">SUMMER 2022</p>
                <h2 className="slider-heading">Save up to 70%</h2>
            ...
            <div className="slider-item fade">
              <div className="slider-image">
                <img src="../../../public/img/slider/slider3.jpg" className="img-fluid" alt />
              </div>
              <div className="container">
                <p className="slider-title">SUMMER 2022</p>
                <h2 className="slider-heading">Save up to 70%</h2>
